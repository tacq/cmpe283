...
EXPORT_SYMBOL(vmextcntr_triple_faults);
EXPORT_SYMBOL(vmextcntr_nmi_windows);
EXPORT_SYMBOL(vmextcntr_io_instructions);
EXPORT_SYMBOL(vmextcntr_cr_accesss);
EXPORT_SYMBOL(vmextcntr_dr_accesss);
EXPORT_SYMBOL(vmextcntr_cpuids);
EXPORT_SYMBOL(vmextcntr_msr_reads);
EXPORT_SYMBOL(vmextcntr_msr_writes);
EXPORT_SYMBOL(vmextcntr_pending_interrupts);
EXPORT_SYMBOL(vmextcntr_hlts);
EXPORT_SYMBOL(vmextcntr_invds);
EXPORT_SYMBOL(vmextcntr_invlpgs);
EXPORT_SYMBOL(vmextcntr_rdpmcs);
EXPORT_SYMBOL(vmextcntr_vmcalls);
EXPORT_SYMBOL(vmextcntr_vmclears);
EXPORT_SYMBOL(vmextcntr_vmlaunchs);
EXPORT_SYMBOL(vmextcntr_vmptrlds);
EXPORT_SYMBOL(vmextcntr_vmptrsts);
EXPORT_SYMBOL(vmextcntr_vmreads);
EXPORT_SYMBOL(vmextcntr_vmresumes);
EXPORT_SYMBOL(vmextcntr_vmwrites);
EXPORT_SYMBOL(vmextcntr_vmoffs);
EXPORT_SYMBOL(vmextcntr_vmons);
EXPORT_SYMBOL(vmextcntr_tpr_below_thresholds);
EXPORT_SYMBOL(vmextcntr_apic_accesss);
EXPORT_SYMBOL(vmextcntr_apic_writes);
EXPORT_SYMBOL(vmextcntr_eoi_induceds);
EXPORT_SYMBOL(vmextcntr_wbinvds);
EXPORT_SYMBOL(vmextcntr_xsetbvs);
EXPORT_SYMBOL(vmextcntr_task_switchs);
EXPORT_SYMBOL(vmextcntr_mce_during_vmentrys);
EXPORT_SYMBOL(vmextcntr_ept_violations);
EXPORT_SYMBOL(vmextcntr_ept_misconfigs);
EXPORT_SYMBOL(vmextcntr_pause_instructions);
EXPORT_SYMBOL(vmextcntr_mwait_instructions);
EXPORT_SYMBOL(vmextcntr_monitor_trap_flags);
EXPORT_SYMBOL(vmextcntr_monitor_instructions);
EXPORT_SYMBOL(vmextcntr_invepts);
EXPORT_SYMBOL(vmextcntr_invvpids);
EXPORT_SYMBOL(vmextcntr_xsavess);
EXPORT_SYMBOL(vmextcntr_xrstorss);
EXPORT_SYMBOL(vmextcntr_pml_fulls);
